...
module.exports.create = async (req, res) => {
    ...
    Models.UserActivity.create({
        ...
        const gs_activity = await gs_client.feed("users", actor._id).addActivity({
        ...
        await Models.UserActivity.findOneAndUpdate({ _id: new_activity._id }, { reference_id: gs_activity.id });
