...
const MentorDetailController = require("../controllers/MentorDetailController");
...
module.exports.init = async (app) => {
    ...
    app.post("/users/:user/mentor-detail", MentorDetailController.updateOrCreateMentorshipDetail);
